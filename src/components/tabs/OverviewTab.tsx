  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 12 }}>
        ...
        {/* 2. Total Videos (ranking appearances) + Views + Growth */}
        <div style={{ background: '#fff', borderRadius: 14, padding: '14px 16px', border: '1px solid #F1F5F9', display: 'flex', flexDirection: 'column', height: '100%', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <span title="Total keyword-video ranking slots. 250 keywords × 20 videos = 5,000. Same video on multiple keywords counted each time." style={{ cursor: 'help' }}><Info size={12} style={{ color: '#CBD5E1' }} /></span>
          </div>
