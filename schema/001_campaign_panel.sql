-- ═══════════════════════════════════════════════════════════════════
-- CAMPAIGN MANAGEMENT PANEL — Database Schema
-- Replaces Google Sheets for influencer campaign lifecycle
-- ═══════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS cp_campaigns (
  ...
  platform_mix TEXT[] NOT NULL DEFAULT '{}',
...
-- ── Rejection Intelligence (Phase 3) ──────────────────────────────
