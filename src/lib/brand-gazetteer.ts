...
const MANUAL_ALIASES: Record<string, string[]> = {
  ...
  'Prestige': ['prestige pressure cooker', 'prestige mixer grinder'],
  'Butterfly': ['butterfly mixer', 'butterfly gas stove'],
  'Borosil': ['borosil glass', 'borosil bottle'],
  'Milton': ['miltonthermos', 'milton bottle', 'milton flask'],
  'Cello': ['cello opalware', 'cello dinner set'],
  'Tupperware': ['tupperware india'],
  ...
  'Bombay Dyeing': ['bombay dyeing bedsheets'],
  'Trident': ['trident group', 'trident towels'],
  ...
  'XYXX': ['xyxx crew'],
  'Rupa': ['rupa briefs', 'rupa innerwear'],
  ...
  'Prestige': ['prestige mixer'],
  'Butterfly': ['butterfly mixer grinder'],
  'Preethi': ['preethi mixer'],
  'Sujata': ['sujata mixer'],
  'Bajaj': ['bajaj mixer', 'bajaj cooker'],
  'Crompton': ['crompton fan', 'crompton motor'],
  'Havells': ['havells fan', 'havells mixer'],
  'Orient': ['orient electric', 'orient fan'],
  'Usha': ['usha fan', 'usha sewing'],
  'Syska': ['syska led', 'syska fan'],
  'Wipro': ['wipro led', 'wipro lighting'],
  ...
  'Spaces': ['spaces welspun'],
  'Portico': ['portico india'],
  'Raymond Home': ['raymond home'],
  'Story@Home': ['story at home'],
  'D\'Decor': ['d decor'],
  'Swayam': ['swayam fashion'],
  'Divine Casa': ['divine casa'],
  'Trance Home Linen': ['trance home'],
  'Chumbak': ['chumbak decor'],
  'Homesake': ['homesake decor'],
  'Hosley': ['hosley decor'],
  'ExclusiveLane': ['exclusive lane'],
  'TIED RIBBONS': ['tied ribbons'],
  'Webelkart': ['webelkart'],
  '@home by Nilkamal': ['at home nilkamal'],
  'Ugaoo': ['ugaoo garden'],
  'TrustBasket': ['trust basket'],
  'Sharpex': ['sharpex garden'],
  'Kraft Seeds': ['kraft seeds garden'],
  'Green Paradise': ['green paradise garden'],
  ...
  'Prestige': ['prestige cookware'],
  'Borosil': ['borosil cookware'],
  'Vinod': ['vinod cookware'],
  'Bergner': ['bergner cookware'],
  'La Opala': ['la opala'],
  'Corelle': ['corelle plates'],
  'Tupperware': ['tupperware bottles'],
  'Signoraware': ['signoraware'],
  ...
  'The Sleep Company': ['sleep company pillow'],
  'Kurlon': ['kurlon foam'],
  ...
  'D\'Decor': ['d decor curtains'],
  'Swayam': ['swayam bedsheets'],
  'Home Centre': ['home centre furniture'],
  'Wakefit': ['wakefit bedsheets'],
  'Trance Home Linen': ['trance bedsheets'],
  'Solimo': ['solimo bedsheets'],
  'Divine Casa': ['divine casa bedsheets'],
  'Homesake': ['homesake lamps'],
  'Hosley': ['hosley candles'],
  'Chumbak': ['chumbak home decor'],
  'Ellementry': ['ellementry decor'],
...
export function loadGazetteer(csvPath?: string): Gazetteer {
  ...
  if (csvPath) {
    ...
    const possiblePaths = [
      join(process.cwd(), 'data', 'brand-gazetteer.json'),
      join(process.cwd(), 'src', 'data', 'brand-gazetteer.json'),
    ]
    for (const p of possiblePaths) {
      if (fs.existsSync(p)) {
        const data = JSON.parse(fs.readFileSync(p, 'utf-8'))
        // Sort brands: canonical brands (no parentBrand) first, then sub-brands
        const sortedBrands = [...data.brands].sort((a: BrandEntry, b: BrandEntry) => {
        ...
        _gazetteer = {
          brands: sortedBrands,
          byCanonical: new Map(sortedBrands.map((b: BrandEntry) => [b.canonical.toLowerCase(), b])),
          byAlias: new Map(),
          categories: new Map(),
          allSearchTerms: [],
        }
    ...
    throw new Error('No gazetteer found. Build it first with buildGazetteerFromCSV().')
  }
